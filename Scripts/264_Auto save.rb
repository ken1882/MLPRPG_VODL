...
class Scene_Map < Scene_Base
  ...
  #--------------------------------------------------------------------------
  def call_menu
    id = ToddAutoSaveAce::STEP_NUM_VAR
    #value = ToddAutoSaveAce::STEP_NUM
    #$game_variables[id] = value if $game_variables[id] == 0
    
    Sound.play_ok
    SceneManager.call(Scene_Menu)
    Window_MenuCommand::init_command_position
    Autosave.call if ToddAutoSaveAce::AUTOSAVEM && Autosave.can_save?
  end
    #--------------------------------------------------------------------------
