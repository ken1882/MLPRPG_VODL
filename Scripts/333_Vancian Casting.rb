  ...
  def init
    push_class("Witch", "arcane", 9){
      ...
      add_progression(
        ...
        58 => [5,5,5,5,5,3,2,1],
        60 => [5,5,5,5,5,3,3,1],
        62 => [5,5,5,5,5,3,3,1,1],
        65 => [5,5,5,5,5,3,3,2,1],
        69 => [5,5,5,5,5,4,3,2,1],
        73 => [5,5,5,5,5,4,4,2,1],
        77 => [5,5,5,5,5,5,4,2,1],
        81 => [5,5,5,5,5,5,5,3,1],
        84 => [5,5,5,5,5,5,5,3,2],
        87 => [5,5,5,5,5,5,5,3,3],
        91 => [5,5,5,5,5,5,5,4,3],
        94 => [5,5,5,5,5,5,5,4,4],
        96 => [5,5,5,5,5,5,5,5,4],
