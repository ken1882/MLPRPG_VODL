...
class Game_Actor < Game_Battler
  ...
  def all_skills
    usable_skills = []
    @skills.each do |id|
      usable_skills.push(id) if $data_skills[id].stype_id != 4
    end
    (usable_skills | added_skills).sort
  end
...
class Window_SkillList_Equip < Window_SkillList
  ...
  def enable?(item)
    ...
    item = $data_skills[item] if item.is_a?(Fixnum)
    return item.stype_id != 4
  end
...
class Window_Properties_Slot < Window_Base
  ...
  def draw_skill_type(y)
    ...
    draw_text(0, y, w, line_height, @item.fire_type, 2)
  ...
  def draw_skill_speed(y)
    ...
    change_color(normal_color)
    draw_text(0, y, w, line_height, @item.tool_speed.to_s, 2)
  end
  
  #--------------------------------------------------------------------------
  # draw_skill_rate (range
  #--------------------------------------------------------------------------
  def draw_skill_rate(y)
    ...
    change_color(normal_color)
    draw_text(0, y, w, line_height, @item.tool_distance.to_s, 2)
  end
  ...
  def draw_skill_cd(y)
    w = contents.width
    change_color(system_color)
    draw_text(0, y, w, line_height, YES::SKILL_EQUIP::PROPERTIES[:recover])
    change_color(normal_color)
    draw_text(0, y, w, line_height, @item.tool_cooldown, 2)
  end
  
  #--------------------------------------------------------------------------
  # draw_skill_damage
  #--------------------------------------------------------------------------
  def draw_skill_damage(y)
    w = contents.width
    change_color(system_color)
    draw_text(0, y, w, line_height, YES::SKILL_EQUIP::PROPERTIES[:damage])
    change_color(normal_color)
    cnt = 0
    for feat in @item.damage_index
      ...
      draw_text(0, (y + cnt * line_height), w, line_height, info , 2)
      cnt += 1
    end
  end
