...
# ** Script Calls
#==============================================================================
# earn_achievement(:mindofakiller)
#
...
#==============================================================================
    ...
    DESCRIPTION[0] = ["???"]
    DESCRIPTION[1] = ["Login gamejolt and start the game"]
    DESCRIPTION[2] = ["Complete Archery Talent Tree"]
    DESCRIPTION[3] = ["Complete Weapon & Shield Talent Tree"]
    DESCRIPTION[4] = ["Complete Dual Weapon Talent Tree"]
    DESCRIPTION[5] = ["Complete Heavy Weapon Talent Tree"]
    DESCRIPTION[6] = ["Complete Primal Talent Tree"]
    DESCRIPTION[7] = ["Complete Entropy Talent Tree"]
    DESCRIPTION[8] = ["Complete Spirit Talent Tree"]
    DESCRIPTION[9] = ["Complete Creation Talent Tree"]
    DESCRIPTION[10] = ["Go into the Crystal Library and start game with Nightmare difficulty."]
    DESCRIPTION[11] = ["Save nopony from Crystal Empire"]
    DESCRIPTION[12] = ["Successfully escape the Crystal Empire without damaged by the shadow crystals."]
    DESCRIPTION[13] = [""]
    DESCRIPTION[14] = [""]
    DESCRIPTION[15] = [""]
    #==========================================================================
    ...
    #
    PROGRESS[0] = [13, 50, "Dream Shards found", :var] # 10 max, tracks variable ID5.
    PROGRESS[1] = [0, 150, "Total Gold", :gold] # 150 max, tracks party's gold.
    PROGRESS[2] = [16, 100, "Total Gold", :var]
    #==========================================================================
    # Rewards Setup
    #==========================================================================
    ...
    ACHIEVEMENT[2] = {
    :symbol => :challenge_accepted,
    :name => "Challenge Accepted!",
    :name_before_unlock => nil,
    :description => DESCRIPTION[10],
    :description_before_unlock => DESCRIPTION[10],
    :progress => nil,
    :reward => nil,
    :graphic => "ACH-challenge_accepted",
    :points => 0,
    :complete_icon => 189,
    :incomplete_icon => 187
    }
    ...
    :description_before_unlock => DESCRIPTION[6],
    :progress => nil,
    :reward => nil,
    :graphic => "ACH-elementalist",
    :points => 0,
    :complete_icon => 189,
    :incomplete_icon => 187
    }
    ...
    :description_before_unlock => DESCRIPTION[12],
    :progress => nil,
    :reward => nil,
    :graphic => nil,
    :points => 0,
    ...
    :description_before_unlock => DESCRIPTION[14],
    :progress => PROGRESS[2],
    :reward => nil,
    :graphic => "ACH - DessI",
    :points => 0,
...
#~     :description_before_unlock => DESCRIPTION[15],
#~     :progress => PROGRESS[0],
#~     :reward => nil,
#~     :graphic => nil,
#~     :points => 0,
...
#~     
#~     ACHIEVEMENT[8] = {
#~     :symbol => :mindofakiller,
#~     :name => "Mind Of A Killer",
#~     :name_before_unlock => "Hidden Achievement",
#~     :description => DESCRIPTION[1],
...
#~     }
    ...
    SOUND = "AOE_mission" # SE Played when an achievement is earned. Set to nil to disable.
    
    POP_ALIGN = :top # Alignment of Popup on map when achievement is earned.
...
class CSCA_Achievement
  ...
  def earn_achievement
    ...
    Audio.se_play("Audio/SE/" + sound,100, 100) if sound
