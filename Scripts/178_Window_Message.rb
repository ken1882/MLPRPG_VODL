...
class Window_Message < Window_Base
  ...
  #--------------------------------------------------------------------------
  def initialize
    puts '[Debug]: Prepare init window base from win_message'
  ...
  def create_all_windows
    @gold_window = Window_Gold.new unless @gold_window && !@gold_window.disposed?
  ...
  def create_back_bitmap
    @back_bitmap = Bitmap.new(width, height) unless @back_bitmap && !@back_bitmap.disposed?
