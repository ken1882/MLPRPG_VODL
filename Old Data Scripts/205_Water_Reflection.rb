...
# WARNING:
#
# Do not release, distribute, edit or change my work without my expressed 
# written consent, doing so violates the terms of use of this work.
#
# I also retain the right to deny permission to use of my work to whoever 
# person, organization, group, etc I want for whichever reason I want to.
#
