...
class Window_MenuCommand < Window_ImageCommand
  ...
  def add_main_commands
    ...
    add_command("Quest",  "Menu_Quest", :quest, main_commands_enabled, nil, "任務日誌")
  end
  #--------------------------------------------------------------------------
  # * Add Formation to Command List
  #--------------------------------------------------------------------------
  def add_formation_command
    add_command(Vocab::formation, "Menu_Party", :formation, main_commands_enabled, nil, "編隊")
  end
  #--------------------------------------------------------------------------
  ...
  def add_save_command
    add_command(Vocab::save, "Menu_Save", :save, save_enabled?, nil, "存檔")
  end
  #--------------------------------------------------------------------------
  # * Add Exit Game to Command List
  #--------------------------------------------------------------------------
  def add_game_end_command
    add_command(Vocab::game_end, "Menu_System", :game_end, true, nil, "系統選項")
  end
  #--------------------------------------------------------------------------
  def save_enabled?
