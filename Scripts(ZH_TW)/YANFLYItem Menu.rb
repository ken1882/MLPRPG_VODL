...
module YEA
  module ITEM
    ...
    # [  :battle,    "Battle"], # Shows Battle-usable items.
      ...
      [:category,  "醫療"],         # <category: Healings>
      [:category,  "書籍"],             # <category: Book>
      [:category,  "卷軸"],           # <category: Scroll>
      [:category,  "暗器"],   # <category: Hidden Weapons>
      [:category,   "特殊物品"],         # <category: Special>
      [:category,"素材"],         # <category: Ingredient>
      [:category,  "樂譜"],
    ...
    VOCAB_STATUS ={
      ...
      :hp_recover => "HP恢復",      # Text used for HP Recovery.
      :mp_recover => "MP恢復",      # Text used for MP Recovery.
