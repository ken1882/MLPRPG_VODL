...
class Game_Battler < Game_BattlerBase
  ...
  attr_accessor :multi_animation_id
  ...
  def state_addable?(state_id)
    ...
    return false if state?(99) #  Petrified
    
    state = $data_states[state_id]
    #--------------------------------------------------------------------------
    #   Anti Magic!
    #--------------------------------------------------------------------------
    return false if state.is_magic? && self.anti_magic?
    #-----------------------------------------------------------------
  ...
  #--------------------------------------------------------------------------
  def reset_state_counts(state_id,bonus_min = 0,bonus_max = 0)
    state = $data_states[state_id]
    variance = 1 + [(state.max_turns + bonus_max) - (state.min_turns + bonus_min), 0].max
