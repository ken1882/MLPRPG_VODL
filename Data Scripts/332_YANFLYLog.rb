...
module YEA
  module COMBAT_LOG
    ...
    TEXT_LOG_CLEAR    = "\\c[4]Previous Log Cleared"    # clear log text
...
class Window_BattleLog < Window_Selectable
  ...
  #--------------------------------------------------------------------------
  # * new method: clear_texts
  #--------------------------------------------------------------------------
  def clear_texts
    @combatlog_window.clear
    @num_wait = 0
    @lines.clear
    refresh
    
    @combatlog_window.add_line("-")
    @combatlog_window.add_line(YEA::COMBAT_LOG::TEXT_LOG_CLEAR)
    @combatlog_window.add_line("-")
  end
