...
class Game_BattlerBase
  ...
  def lunatic_state_extension(effect, state, user, state_origin, log_window, attacker = nil)
    ...
    # ● Glyph of Repulsion
    #======================================================================
    when /APPLY_GLYPH_REPULSION/i
      @state_info[287] = $current_user.difficulty_class('int')
    #======================================================================
    # ● Glyph of Repulsion
    #======================================================================
    when /GLYPH_REPULSION/i
      # jump to tag: damage
      
    #======================================================================
    # ● Glyph of Neturalization
    #======================================================================
    when /GLYPH_NETURALIZATION/i
      return unless $current_damage_type == 2 || $current_using_item.is_spell?
      @result.hp_damage = @result.hp_drain = 0
      @result.mp_damage = @result.mp_drain = 0
    #----------------------------------------------------------------------
