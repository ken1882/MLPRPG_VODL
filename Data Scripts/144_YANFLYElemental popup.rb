...
module YEA
  module ELEMENT_POPUPS
    ...
    # ElementID => [ Zoom1, Zoom2, Sz, Bold, Italic, Red, Grn, Blu, Font]
              3 => [   2.0,   1.0, 70, false,  true, 240,  60,  60, DEFAULT], 
              4 => [   2.0,   1.0, 70, false,  true, 100, 200, 246, DEFAULT],
              5 => [   2.0,   1.0, 70, false,  true, 255, 255, 160, DEFAULT],
              6 => [   2.0,   1.0, 70, false,  true,   0, 115, 180, DEFAULT],
              7 => [   2.0,   1.0, 70, false,  true, 240, 135,  80, DEFAULT],
              8 => [   2.0,   1.0, 70, false,  true,  60, 180,  75, DEFAULT],
              9 => [   2.0,   1.0, 70, false,  true, 175, 210, 255, DEFAULT],
             10 => [   2.0,   1.0, 70, false,  true, 110,  80, 130, DEFAULT],
             11 => [   2.0,   1.0, 70, false,  true,  85, 153, 255, DEFAULT],
             12 => [   2.0,   1.0, 70, false,  true, -68, 255, 119, DEFAULT],              
             18 => [   2.0,   1.0, 100, false,  true, 255, 153, 0,   DEFAULT],
             19 => [   2.0,   1.0, 70, false,  true, 255, 85, -255, DEFAULT],
            } # Do not remove this.
